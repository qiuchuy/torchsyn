...
static int input_shape_0[] = {};
    ...
    input_ndims[0] = 0;
    input_data[0] = (float*)malloc(1.0 * sizeof(float));
...
void model_forward(float** inputs, float** outputs,
    ...
    // outputs[0..4]: output tensor data (raw pointers)
    ...
    // Allocate v_1 (operation: Abs)
    v_1 = (float*)malloc(1.0 * sizeof(float));
    v_1_shape[0] = 1;
    v_1_shape[1] = 1;
    v_1_shape[2] = 1;
    v_1_shape[3] = 1;
    ...
    v_3 = (float*)malloc(1.0 * sizeof(float));
    v_3_shape[0] = 1;
    v_3_shape[1] = 1;
    v_3_shape[2] = 1;
    v_3_shape[3] = 1;
    ...
    op_floor(v_3, v_4, 1.0);


    // Allocate v_5 (operation: CastF64)
    v_5 = (float*)malloc(1.0 * sizeof(float));
    v_5_shape[0] = 1;
    v_5_shape[1] = 1;
    v_5_shape[2] = 1;
    v_5_shape[3] = 1;
    ...
    op_cast_f64(v_3, v_5, 1.0);


    // Allocate v_6 (operation: CastF32)
    v_6 = (float*)malloc(1.0 * sizeof(float));
    v_6_shape[0] = 1;
    v_6_shape[1] = 1;
    v_6_shape[2] = 1;
    v_6_shape[3] = 1;
    ...
    op_cast_f32(v_3, v_6, 1.0);


    // Allocate v_7 (operation: ExpandLast2)
    ...
    op_expand(v_6, v_7, 0, 1);


    // Allocate v_8 (operation: PReLU)
    ...
    op_leaky_relu(v_6, v_8, 1.0, 0.01f);


    // Allocate v_9 (operation: ExpandLast2)
    v_9 = (float*)malloc(1 * sizeof(float));
    v_9_shape[0] = 1;
    v_9_shape[1] = 1;
    v_9_shape[2] = 1;
    v_9_shape[3] = 1;
    ...
    op_expand(v_8, v_9, 0, 1);


    // Allocate v_10 (operation: Mul)
    v_10 = (float*)malloc(1.0 * sizeof(float));
    v_10_shape[0] = 1;
    v_10_shape[1] = 1;
    v_10_shape[2] = 1;
    v_10_shape[3] = 1;
    ...
    op_mul(v_6, v_8, v_10, 1.0);

    // Copy output v3_0 to output buffer 0
    memcpy(outputs[0], v_4, 1.0 * sizeof(float));

    // Copy output v2_0 to output buffer 1
    memcpy(outputs[1], v_5, 1.0 * sizeof(float));

    // Copy output v7_0 to output buffer 2
    memcpy(outputs[2], v_7, 1 * sizeof(float));

    // Copy output v8_0 to output buffer 3
    memcpy(outputs[3], v_9, 1 * sizeof(float));

    // Copy output v6_0 to output buffer 4
    memcpy(outputs[4], v_10, 1.0 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v4_0): shape=[], size=1.0\n");
    ...
    float* output_data[5];
    static int output_shape_arrays[5][4]; // Max 4D tensors
    const int* output_shapes[5];
    int output_ndims[5];
    ...
    // Output 2: v7_0
    static int output_shape_2[] = {1, 1};
    output_shapes[2] = output_shape_2;
    output_ndims[2] = 2;

    // Output 3: v8_0
    static int output_shape_3[] = {1, 1};
    output_shapes[3] = output_shape_3;
    output_ndims[3] = 2;

    // Output 4: v6_0
    static int output_shape_4[] = {};
    ...
    printf("  Output 2 (v7_0, shape: 1x1):\n");
    printf("  [");
    for (int j = 0; j < 1; j++) {
    ...
    printf("  Output 3 (v8_0, shape: 1x1):\n");
    printf("  [");
    for (int j = 0; j < 1; j++) {
