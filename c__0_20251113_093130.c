...
void model_forward(float** inputs, float** outputs,
    ...
    // Allocate v_2 (operation: PTMatMul)
    ...
    memcpy(v_2, v_1, 1.0 * sizeof(float));


    // Allocate v_3 (operation: Sin)
    ...
    // Allocate v_7 (operation: Abs)
    v_7 = (float*)malloc(1.0 * sizeof(float));
    v_7_shape[0] = 1;
    v_7_shape[1] = 1;
    v_7_shape[2] = 1;
    v_7_shape[3] = 1;
    ...
    op_greater(v_7, v_2, v_8, 1.0);


    // Allocate v_9 (operation: Sigmoid)
    ...
    op_sigmoid(v_7, v_9, 1.0);


    // Allocate v_10 (operation: Atan)
    ...
    op_atan(v_7, v_10, 1.0);


    // Allocate v_11 (operation: Less)
    ...
    op_less(v_10, v_7, v_11, 1.0);

    // Copy output v6_0 to output buffer 0
    memcpy(outputs[0], v_4, 1.0 * sizeof(float));

    // Copy output v9_0 to output buffer 1
    memcpy(outputs[1], v_8, 1.0 * sizeof(float));

    // Copy output v0_0 to output buffer 2
    memcpy(outputs[2], v_9, 1.0 * sizeof(float));

    // Copy output v1_0 to output buffer 3
    memcpy(outputs[3], v_11, 1.0 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v11_0): shape=[1], size=1\n");

    printf("  Input 1 (v10_0): shape=[1], size=1\n");
