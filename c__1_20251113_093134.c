...
static int input_shape_0[] = {1, 38, 20, 1, 1};
static int input_shape_1[] = {24};
static int input_shape_2[] = {38, 20, 3, 1};



    // Input 0: v12_0 (shape: 1x38x20x1x1)
    input_shapes[0] = input_shape_0;
    input_ndims[0] = 5;
    input_data[0] = (float*)malloc(760 * sizeof(float));
    ...
    // Input 1: v8_0 (shape: 24)
    input_shapes[1] = input_shape_1;
    input_ndims[1] = 1;
    input_data[1] = (float*)malloc(24 * sizeof(float));
    ...
    // Input 2: v5_0 (shape: 38x20x3x1)
    input_shapes[2] = input_shape_2;
    input_ndims[2] = 4;
    input_data[2] = (float*)malloc(2280 * sizeof(float));

    // Initialize with random values or test data
    for (int j = 0; j < 2280; j++) {
        input_data[2][j] = (float)rand() / RAND_MAX;  // Random [0, 1]
    }
...
void model_forward(float** inputs, float** outputs,
                       const int** input_shapes, const int** output_shapes,
                       const int* input_ndims, const int* output_ndims) {
    // inputs[0..2]: input tensor data (raw pointers)
    // outputs[0..3]: output tensor data (raw pointers)
    ...
    // Allocate v_3 (operation: Floor)
    v_3 = (float*)malloc(760 * sizeof(float));
    v_3_shape[0] = 1;
    v_3_shape[1] = 38;
    v_3_shape[2] = 20;
    v_3_shape[3] = 1;
    ...
    op_floor(v_0, v_3, 760);


    // Allocate v_4 (operation: Add)
    v_4 = (float*)malloc(18240 * sizeof(float));
    v_4_shape[0] = 1;
    v_4_shape[1] = 38;
    v_4_shape[2] = 20;
    v_4_shape[3] = 1;
    ...
    op_add(v_3, v_1, v_4, 18240);


    // Allocate v_5 (operation: Squeeze)
    v_5 = (float*)malloc(18240 * sizeof(float));
    v_5_shape[0] = 1;
    v_5_shape[1] = 38;
    v_5_shape[2] = 20;
    v_5_shape[3] = 24;
    ...
    op_squeeze(v_4, v_5, 18240);


    // Allocate v_6 (operation: Concat1)
    v_6 = (float*)malloc(2280 * sizeof(float));
    v_6_shape[0] = 38;
    v_6_shape[1] = 20;
    v_6_shape[2] = 3;
    v_6_shape[3] = 1;
    ...
    op_concat1((const float*[]){v_2}, v_6, (int[]){2280}, 1);


    // Allocate v_7 (operation: Atan)
    v_7 = (float*)malloc(18240 * sizeof(float));
    v_7_shape[0] = 1;
    v_7_shape[1] = 38;
    v_7_shape[2] = 20;
    v_7_shape[3] = 1;
    ...
    op_atan(v_4, v_7, 18240);


    // Allocate v_8 (operation: Greater)
    v_8 = (float*)malloc(54720 * sizeof(float));
    v_8_shape[0] = 1;
    v_8_shape[1] = 38;
    v_8_shape[2] = 20;
    v_8_shape[3] = 3;
    ...
    op_greater(v_2, v_7, v_8, 54720);


    // Allocate v_9 (operation: Div)
    v_9 = (float*)malloc(54720 * sizeof(float));
    v_9_shape[0] = 1;
    v_9_shape[1] = 38;
    v_9_shape[2] = 20;
    v_9_shape[3] = 3;
    ...
    op_div(v_6, v_4, v_9, 54720);


    // Allocate v_10 (operation: Sigmoid)
    v_10 = (float*)malloc(54720 * sizeof(float));
    v_10_shape[0] = 1;
    v_10_shape[1] = 38;
    v_10_shape[2] = 20;
    v_10_shape[3] = 3;
    ...
    op_sigmoid(v_9, v_10, 54720);


    // Allocate v_11 (operation: Concat1)
    v_11 = (float*)malloc(54720 * sizeof(float));
    v_11_shape[0] = 1;
    v_11_shape[1] = 38;
    v_11_shape[2] = 20;
    v_11_shape[3] = 3;
    ...
    op_concat1((const float*[]){v_9}, v_11, (int[]){54720}, 1);


    // Allocate v_12 (operation: TrilinearInterp)
    v_12 = (float*)malloc(38 * sizeof(float));
    v_12_shape[0] = 1;
    v_12_shape[1] = 38;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    op_trilinear_interp(v_11, v_12, 38, 38);

    // Copy output v11_0 to output buffer 0
    memcpy(outputs[0], v_5, 18240 * sizeof(float));

    // Copy output v10_0 to output buffer 1
    memcpy(outputs[1], v_8, 54720 * sizeof(float));

    // Copy output v1_0 to output buffer 2
    memcpy(outputs[2], v_10, 54720 * sizeof(float));

    // Copy output v3_0 to output buffer 3
    memcpy(outputs[3], v_12, 38 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v12_0): shape=[1x38x20x1x1], size=760\n");

    printf("  Input 1 (v8_0): shape=[24], size=24\n");

    printf("  Input 2 (v5_0): shape=[38x20x3x1], size=2280\n");
    ...
    float* output_data[4];
    static int output_shape_arrays[4][4]; // Max 4D tensors
    const int* output_shapes[4];
    int output_ndims[4];

    // Set up output shapes

    // Output 0: v11_0
    static int output_shape_0[] = {1, 38, 20, 24};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 4;

    // Output 1: v10_0
    static int output_shape_1[] = {1, 38, 20, 3, 24};
    output_shapes[1] = output_shape_1;
    output_ndims[1] = 5;

    // Output 2: v1_0
    static int output_shape_2[] = {1, 38, 20, 3, 24};
    output_shapes[2] = output_shape_2;
    output_ndims[2] = 5;

    // Output 3: v3_0
    static int output_shape_3[] = {1, 38, 1, 1, 1};
    output_shapes[3] = output_shape_3;
    output_ndims[3] = 5;
    ...
    printf("  Output 0 (v11_0, shape: 1x38x20x24):\n");
    printf("  [");
    for (int j = 0; j < 18240; j++) {
    ...
    printf("  Output 1 (v10_0, shape: 1x38x20x3x24):\n");
    printf("  [");
    for (int j = 0; j < 54720; j++) {
    ...
    printf("  Output 2 (v1_0, shape: 1x38x20x3x24):\n");
    printf("  [");
    for (int j = 0; j < 54720; j++) {
    ...
    printf("  Output 3 (v3_0, shape: 1x38x1x1x1):\n");
    printf("  [");
    for (int j = 0; j < 38; j++) {
        printf("%.6f", output_data[3][j]);
        if (j < 38 - 1) printf(", ");
        if ((j + 1) % 8 == 0) printf("\n   ");
    }
    printf("]\n\n");
