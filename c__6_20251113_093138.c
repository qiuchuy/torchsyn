...
static int input_shape_0[] = {1, 5, 54, 11, 1};



    // Input 0: v6_0 (shape: 1x5x54x11x1)
    input_shapes[0] = input_shape_0;
    input_ndims[0] = 5;
    input_data[0] = (float*)malloc(2970 * sizeof(float));

    // Initialize with random values or test data
    for (int j = 0; j < 2970; j++) {
...
void model_forward(float** inputs, float** outputs,
    ...
    // outputs[0..5]: output tensor data (raw pointers)
    ...
    // Allocate v_1 (operation: Softmax)
    v_1 = (float*)malloc(2970 * sizeof(float));
    v_1_shape[0] = 1;
    v_1_shape[1] = 5;
    v_1_shape[2] = 54;
    v_1_shape[3] = 11;
    ...
    op_softmax(v_0, v_1, 2970, -1);


    // Allocate v_2 (operation: Clip)
    v_2 = (float*)malloc(2970 * sizeof(float));
    v_2_shape[0] = 1;
    v_2_shape[1] = 5;
    v_2_shape[2] = 54;
    v_2_shape[3] = 11;
    ...
    op_clip(v_1, v_2, 2970, 0.0f, 1.0f);


    // Allocate v_3 (operation: GELU)
    v_3 = (float*)malloc(2970 * sizeof(float));
    v_3_shape[0] = 1;
    v_3_shape[1] = 5;
    v_3_shape[2] = 54;
    v_3_shape[3] = 11;
    ...
    op_gelu(v_2, v_3, 2970);


    // Allocate v_4 (operation: Tan)
    v_4 = (float*)malloc(2970 * sizeof(float));
    v_4_shape[0] = 1;
    v_4_shape[1] = 5;
    v_4_shape[2] = 54;
    v_4_shape[3] = 11;
    ...
    // Allocate v_5 (operation: Ceil)
    v_5 = (float*)malloc(2970 * sizeof(float));
    v_5_shape[0] = 1;
    v_5_shape[1] = 5;
    v_5_shape[2] = 54;
    v_5_shape[3] = 11;
    ...
    op_ceil(v_3, v_5, 2970);


    // Allocate v_6 (operation: Atan)
    v_6 = (float*)malloc(2970 * sizeof(float));
    v_6_shape[0] = 1;
    v_6_shape[1] = 5;
    v_6_shape[2] = 54;
    v_6_shape[3] = 11;
    ...
    op_atan(v_3, v_6, 2970);


    // Allocate v_7 (operation: Ceil)
    v_7 = (float*)malloc(2970 * sizeof(float));
    v_7_shape[0] = 1;
    v_7_shape[1] = 5;
    v_7_shape[2] = 54;
    v_7_shape[3] = 11;
    ...
    op_ceil(v_3, v_7, 2970);


    // Allocate v_8 (operation: ArgMax)
    v_8 = (float*)malloc(2970 * sizeof(float));
    v_8_shape[0] = 1;
    v_8_shape[1] = 5;
    v_8_shape[2] = 54;
    v_8_shape[3] = 11;
    ...
    v_8[0] = (float)op_argmax(v_7, 2970);


    // Allocate v_9 (operation: ConstPad)
    v_9 = (float*)malloc(2970 * sizeof(float));
    v_9_shape[0] = 1;
    v_9_shape[1] = 5;
    v_9_shape[2] = 54;
    v_9_shape[3] = 11;
    ...
    op_const_pad(v_7, v_9, 1485, 2970, 0.0f);


    // Allocate v_10 (operation: Greater)
    v_10 = (float*)malloc(2970 * sizeof(float));
    v_10_shape[0] = 1;
    v_10_shape[1] = 5;
    v_10_shape[2] = 54;
    v_10_shape[3] = 11;
    ...
    op_greater(v_7, v_7, v_10, 2970);

    // Copy output v8_0 to output buffer 0
    memcpy(outputs[0], v_4, 2970 * sizeof(float));

    // Copy output v3_0 to output buffer 1
    memcpy(outputs[1], v_5, 2970 * sizeof(float));

    // Copy output v0_0 to output buffer 2
    memcpy(outputs[2], v_6, 2970 * sizeof(float));

    // Copy output v5_0 to output buffer 3
    memcpy(outputs[3], v_8, 2970 * sizeof(float));

    // Copy output v2_0 to output buffer 4
    memcpy(outputs[4], v_9, 2970 * sizeof(float));

    // Copy output v1_0 to output buffer 5
    memcpy(outputs[5], v_10, 2970 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v6_0): shape=[1x5x54x11x1], size=2970\n");
    ...
    float* output_data[6];
    static int output_shape_arrays[6][4]; // Max 4D tensors
    const int* output_shapes[6];
    int output_ndims[6];

    // Set up output shapes

    // Output 0: v8_0
    static int output_shape_0[] = {1, 5, 54, 11, 1};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 5;

    // Output 1: v3_0
    static int output_shape_1[] = {1, 5, 54, 11, 1};
    output_shapes[1] = output_shape_1;
    output_ndims[1] = 5;

    // Output 2: v0_0
    static int output_shape_2[] = {1, 5, 54, 11, 1};
    output_shapes[2] = output_shape_2;
    output_ndims[2] = 5;

    // Output 3: v5_0
    static int output_shape_3[] = {1, 5, 54, 11};
    output_shapes[3] = output_shape_3;
    output_ndims[3] = 4;

    // Output 4: v2_0
    static int output_shape_4[] = {1, 5, 54, 11, 1};
    output_shapes[4] = output_shape_4;
    output_ndims[4] = 5;

    // Output 5: v1_0
    static int output_shape_5[] = {1, 5, 54, 11, 1};
    output_shapes[5] = output_shape_5;
    output_ndims[5] = 5;
    ...
    printf("  Output 0 (v8_0, shape: 1x5x54x11x1):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
    ...
    printf("  Output 1 (v3_0, shape: 1x5x54x11x1):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
    ...
    printf("  Output 2 (v0_0, shape: 1x5x54x11x1):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
    ...
    printf("  Output 3 (v5_0, shape: 1x5x54x11):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
    ...
    printf("  Output 4 (v2_0, shape: 1x5x54x11x1):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
        printf("%.6f", output_data[4][j]);
        if (j < 2970 - 1) printf(", ");
        if ((j + 1) % 8 == 0) printf("\n   ");
    }
    printf("]\n\n");

    printf("  Output 5 (v1_0, shape: 1x5x54x11x1):\n");
    printf("  [");
    for (int j = 0; j < 2970; j++) {
        printf("%.6f", output_data[5][j]);
        if (j < 2970 - 1) printf(", ");
        if ((j + 1) % 8 == 0) printf("\n   ");
    }
    printf("]\n\n");
