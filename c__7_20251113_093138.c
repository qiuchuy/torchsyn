...
static int input_shape_0[] = {1, 2};
static int input_shape_1[] = {1, 1};
static int input_shape_2[] = {2, 2, 1, 1, 2};



    // Input 0: v12_0 (shape: 1x2)
    input_shapes[0] = input_shape_0;
    input_ndims[0] = 2;
    input_data[0] = (float*)malloc(2 * sizeof(float));
    ...
    // Input 2: v8_0 (shape: 2x2x1x1x2)
    input_shapes[2] = input_shape_2;
    input_ndims[2] = 5;
    input_data[2] = (float*)malloc(8 * sizeof(float));
...
void model_forward(float** inputs, float** outputs,
    ...
    // Allocate v_3 (operation: Where)
    v_3 = (float*)malloc(8 * sizeof(float));
    v_3_shape[0] = 2;
    v_3_shape[1] = 2;
    v_3_shape[2] = 1;
    v_3_shape[3] = 1;
    ...
    op_where(v_2, v_1, v_0, v_3, 8);


    // Allocate v_4 (operation: Atan)
    v_4 = (float*)malloc(8 * sizeof(float));
    v_4_shape[0] = 2;
    v_4_shape[1] = 2;
    v_4_shape[2] = 1;
    v_4_shape[3] = 1;
    ...
    // Allocate v_5 (operation: GELU)
    v_5 = (float*)malloc(8 * sizeof(float));
    v_5_shape[0] = 2;
    v_5_shape[1] = 2;
    v_5_shape[2] = 1;
    v_5_shape[3] = 1;
    ...
    // Allocate v_6 (operation: Reshape)
    v_6 = (float*)malloc(8 * sizeof(float));
    v_6_shape[0] = 4;
    v_6_shape[1] = 2;
    v_6_shape[2] = 1;
    v_6_shape[3] = 1;
    ...
    op_reshape(v_5, v_6, 8);


    // Allocate v_7 (operation: TorchReduceSum)
    ...
    // Allocate v_8 (operation: TorchReduceSum)
    v_8 = (float*)malloc(2 * sizeof(float));
    v_8_shape[0] = 2;
    v_8_shape[1] = 1;
    v_8_shape[2] = 1;
    v_8_shape[3] = 1;
    ...
    v_9[0] = op_reducemin(v_8, 1);


    // Allocate v_10 (operation: Tan)
    v_10 = (float*)malloc(1 * sizeof(float));
    v_10_shape[0] = 1;
    v_10_shape[1] = 1;
    v_10_shape[2] = 1;
    v_10_shape[3] = 1;
    ...
    // Allocate v_11 (operation: Ceil)
    v_11 = (float*)malloc(1 * sizeof(float));
    v_11_shape[0] = 1;
    v_11_shape[1] = 1;
    v_11_shape[2] = 1;
    v_11_shape[3] = 1;
    ...
    // Allocate v_12 (operation: CastBool)
    v_12 = (float*)malloc(1 * sizeof(float));
    v_12_shape[0] = 1;
    v_12_shape[1] = 1;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    op_cast_bool(v_10, v_12, 1);

    // Copy output v7_0 to output buffer 0
    memcpy(outputs[0], v_7, 2 * sizeof(float));

    // Copy output v4_0 to output buffer 1
    memcpy(outputs[1], v_11, 1 * sizeof(float));

    // Copy output v0_0 to output buffer 2
    memcpy(outputs[2], v_12, 1 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v12_0): shape=[1x2], size=2\n");

    printf("  Input 1 (v11_0): shape=[1x1], size=1\n");

    printf("  Input 2 (v8_0): shape=[2x2x1x1x2], size=8\n");
    ...
    // Output 0: v7_0
    static int output_shape_0[] = {2, 1};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 2;

    // Output 1: v4_0
    static int output_shape_1[] = {1};
    output_shapes[1] = output_shape_1;
    output_ndims[1] = 1;

    // Output 2: v0_0
    static int output_shape_2[] = {1};
    ...
    printf("  Output 0 (v7_0, shape: 2x1):\n");
    printf("  [");
    for (int j = 0; j < 2; j++) {
