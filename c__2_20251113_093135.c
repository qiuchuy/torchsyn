...
static int input_shape_0[] = {63, 1};



    // Input 0: v3_0 (shape: 63x1)
    input_shapes[0] = input_shape_0;
    input_ndims[0] = 2;
    input_data[0] = (float*)malloc(63 * sizeof(float));
...
void model_forward(float** inputs, float** outputs,
    ...
    v_1 = (float*)malloc(2 * sizeof(float));
    v_1_shape[0] = 1;
    v_1_shape[1] = 2;
    v_1_shape[2] = 1;
    v_1_shape[3] = 1;
    ...
    // Allocate v_2 (operation: Constant)
    v_2 = (float*)malloc(1.0 * sizeof(float));
    v_2_shape[0] = 1;
    v_2_shape[1] = 1;
    v_2_shape[2] = 1;
    v_2_shape[3] = 1;
    ...
    // Allocate v_3 (operation: Max)
    v_3 = (float*)malloc(2 * sizeof(float));
    v_3_shape[0] = 1;
    v_3_shape[1] = 2;
    v_3_shape[2] = 1;
    v_3_shape[3] = 1;
    ...
    op_max(v_2, v_1, v_3, 2);


    // Allocate v_4 (operation: Constant)
    v_4 = (float*)malloc(2142 * sizeof(float));
    v_4_shape[0] = 63;
    v_4_shape[1] = 34;
    v_4_shape[2] = 1;
    v_4_shape[3] = 1;
    ...
    // Allocate v_5 (operation: CastI32)
    v_5 = (float*)malloc(2142 * sizeof(float));
    v_5_shape[0] = 63;
    v_5_shape[1] = 34;
    v_5_shape[2] = 1;
    v_5_shape[3] = 1;
    ...
    op_cast_i32(v_4, v_5, 2142);


    // Allocate v_6 (operation: Constant)
    v_6 = (float*)malloc(63 * sizeof(float));
    v_6_shape[0] = 63;
    v_6_shape[1] = 1;
    v_6_shape[2] = 1;
    v_6_shape[3] = 1;
    ...
    // Allocate v_7 (operation: Concat2)
    v_7 = (float*)malloc(2205 * sizeof(float));
    v_7_shape[0] = 63;
    v_7_shape[1] = 35;
    v_7_shape[2] = 1;
    v_7_shape[3] = 1;
    ...
    op_concat1((const float*[]){v_6}, v_7, (int[]){2205}, 1);


    // Allocate v_8 (operation: Constant)
    v_8 = (float*)malloc(63 * sizeof(float));
    v_8_shape[0] = 63;
    v_8_shape[1] = 1;
    v_8_shape[2] = 1;
    v_8_shape[3] = 1;
    ...
    v_9 = (float*)malloc(126 * sizeof(float));
    v_9_shape[0] = 63;
    v_9_shape[1] = 2;
    v_9_shape[2] = 1;
    v_9_shape[3] = 1;
    ...
    op_matmul(v_8, v_3, v_9, 63, 2, 2);


    // Allocate v_10 (operation: Constant)
    v_10 = (float*)malloc(63 * sizeof(float));
    v_10_shape[0] = 63;
    v_10_shape[1] = 1;
    v_10_shape[2] = 1;
    v_10_shape[3] = 1;
    ...
    // Allocate v_11 (operation: Abs)
    v_11 = (float*)malloc(63 * sizeof(float));
    v_11_shape[0] = 63;
    v_11_shape[1] = 1;
    v_11_shape[2] = 1;
    v_11_shape[3] = 1;
    ...
    // Allocate v_12 (operation: Less)
    v_12 = (float*)malloc(63 * sizeof(float));
    v_12_shape[0] = 63;
    v_12_shape[1] = 1;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    op_less(v_11, v_0, v_12, 63);


    // Allocate v_13 (operation: Or)
    v_13 = (float*)malloc(63 * sizeof(float));
    v_13_shape[0] = 63;
    v_13_shape[1] = 1;
    v_13_shape[2] = 1;
    v_13_shape[3] = 1;
    ...
    op_or(v_12, v_12, v_13, 63);


    // Allocate v_14 (operation: Concat4)
    v_14 = (float*)malloc(2457 * sizeof(float));
    v_14_shape[0] = 63;
    v_14_shape[1] = 39;
    v_14_shape[2] = 1;
    v_14_shape[3] = 1;
    ...
    // Concat4: using simplified implementation

    op_concat1((const float*[]){v_9}, v_14, (int[]){2457}, 1);


    // Allocate v_15 (operation: CastI64)
    v_15 = (float*)malloc(2457 * sizeof(float));
    v_15_shape[0] = 63;
    v_15_shape[1] = 39;
    v_15_shape[2] = 1;
    v_15_shape[3] = 1;
    ...
    op_cast_i64(v_14, v_15, 2457);


    // Allocate v_16 (operation: Where)
    v_16 = (float*)malloc(2457 * sizeof(float));
    v_16_shape[0] = 63;
    v_16_shape[1] = 39;
    v_16_shape[2] = 1;
    v_16_shape[3] = 1;
    ...
    op_where(v_12, v_15, v_15, v_16, 2457);

    // Copy output v9_0 to output buffer 0
    memcpy(outputs[0], v_13, 63 * sizeof(float));

    // Copy output v1_0 to output buffer 1
    memcpy(outputs[1], v_16, 2457 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v3_0): shape=[63x1], size=63\n");
    ...
    // Output 0: v9_0
    static int output_shape_0[] = {63, 1};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 2;

    // Output 1: v1_0
    static int output_shape_1[] = {63, 39};
    ...
    printf("  Output 0 (v9_0, shape: 63x1):\n");
    printf("  [");
    for (int j = 0; j < 63; j++) {
    ...
    printf("  Output 1 (v1_0, shape: 63x39):\n");
    printf("  [");
    for (int j = 0; j < 2457; j++) {
