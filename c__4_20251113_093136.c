...
static int input_shape_1[] = {1, 1, 1};
static int input_shape_2[] = {38, 1, 54};



    // Input 0: v14_0 (shape: 1)
    ...
    // Input 2: v1_0 (shape: 38x1x54)
    input_shapes[2] = input_shape_2;
    input_ndims[2] = 3;
    input_data[2] = (float*)malloc(2052 * sizeof(float));
...
void model_forward(float** inputs, float** outputs,
    ...
    // Allocate v_4 (operation: Constant)
    v_4 = (float*)malloc(1.0 * sizeof(float));
    v_4_shape[0] = 1;
    v_4_shape[1] = 1;
    v_4_shape[2] = 1;
    v_4_shape[3] = 1;
    ...
    // Allocate v_5 (operation: Greater)
    ...
    op_greater(v_4, v_3, v_5, 1);


    // Allocate v_6 (operation: And)
    ...
    op_and(v_5, v_5, v_6, 1);


    // Allocate v_7 (operation: Concat1)
    v_7 = (float*)malloc(1 * sizeof(float));
    v_7_shape[0] = 1;
    v_7_shape[1] = 1;
    v_7_shape[2] = 1;
    v_7_shape[3] = 1;
    ...
    op_concat1((const float*[]){v_1}, v_7, (int[]){1}, 1);


    // Allocate v_8 (operation: Constant)
    v_8 = (float*)malloc(1.0 * sizeof(float));
    v_8_shape[0] = 1;
    v_8_shape[1] = 1;
    v_8_shape[2] = 1;
    v_8_shape[3] = 1;
    ...
    // Allocate v_9 (operation: Min)
    v_9 = (float*)malloc(2052 * sizeof(float));
    v_9_shape[0] = 38;
    v_9_shape[1] = 1;
    v_9_shape[2] = 54;
    v_9_shape[3] = 1;
    ...
    op_min(v_2, v_8, v_9, 2052);


    // Allocate v_10 (operation: Where)
    v_10 = (float*)malloc(2052 * sizeof(float));
    v_10_shape[0] = 38;
    v_10_shape[1] = 1;
    v_10_shape[2] = 54;
    v_10_shape[3] = 1;
    ...
    op_where(v_5, v_7, v_9, v_10, 2052);


    // Allocate v_11 (operation: Squeeze)
    v_11 = (float*)malloc(2052 * sizeof(float));
    v_11_shape[0] = 38;
    v_11_shape[1] = 54;
    v_11_shape[2] = 1;
    v_11_shape[3] = 1;
    ...
    op_squeeze(v_10, v_11, 2052);


    // Allocate v_12 (operation: Transpose)
    v_12 = (float*)malloc(2052 * sizeof(float));
    v_12_shape[0] = 54;
    v_12_shape[1] = 38;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    // Transpose: using simplified implementation

    op_transpose(v_11, v_12, (int[]){1, 1, 1, 1}, (int[]){0, 1, 2, 3}, 2);


    // Allocate v_13 (operation: Flatten)
    v_13 = (float*)malloc(2052 * sizeof(float));
    v_13_shape[0] = 2052;
    v_13_shape[1] = 1;
    v_13_shape[2] = 1;
    v_13_shape[3] = 1;
    ...
    // Unsupported operation: Flatten, copying input to v_13

    memcpy(v_13, v_12, 2052 * sizeof(float));


    // Allocate v_14 (operation: Reshape)
    v_14 = (float*)malloc(2052 * sizeof(float));
    v_14_shape[0] = 1;
    v_14_shape[1] = 1;
    v_14_shape[2] = 2052;
    v_14_shape[3] = 1;
    ...
    op_reshape(v_13, v_14, 2052);

    // Copy output v13_0 to output buffer 0
    memcpy(outputs[0], v_6, 1 * sizeof(float));

    // Copy output v4_0 to output buffer 1
    memcpy(outputs[1], v_14, 2052 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v14_0): shape=[1], size=1\n");

    printf("  Input 1 (v6_0): shape=[1x1x1], size=1\n");

    printf("  Input 2 (v1_0): shape=[38x1x54], size=2052\n");
    ...
    // Output 0: v13_0
    static int output_shape_0[] = {1};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 1;

    // Output 1: v4_0
    static int output_shape_1[] = {1, 1, 2052};
    ...
    printf("  Output 1 (v4_0, shape: 1x1x2052):\n");
    printf("  [");
    for (int j = 0; j < 2052; j++) {
