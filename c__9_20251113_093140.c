...
static int input_shape_0[] = {1};
static int input_shape_1[] = {1, 52};
static int input_shape_2[] = {1, 52};



    // Input 0: v15_0 (shape: 1)
    ...
    // Input 1: v0_0 (shape: 1x52)
    input_shapes[1] = input_shape_1;
    input_ndims[1] = 2;
    input_data[1] = (float*)malloc(52 * sizeof(float));
    ...
    // Input 2: v5_0 (shape: 1x52)
    input_shapes[2] = input_shape_2;
    input_ndims[2] = 2;
    input_data[2] = (float*)malloc(52 * sizeof(float));
...
void model_forward(float** inputs, float** outputs,
    ...
    // Allocate v_3 (operation: Constant)
    ...
    op_min(v_3, v_0, v_4, 1);


    // Allocate v_5 (operation: Softmax)
    v_5 = (float*)malloc(52 * sizeof(float));
    v_5_shape[0] = 1;
    v_5_shape[1] = 52;
    v_5_shape[2] = 1;
    v_5_shape[3] = 1;
    ...
    op_softmax(v_1, v_5, 52, -1);


    // Allocate v_6 (operation: Constant)
    v_6 = (float*)malloc(2 * sizeof(float));
    v_6_shape[0] = 2;
    v_6_shape[1] = 1;
    v_6_shape[2] = 1;
    v_6_shape[3] = 1;
    ...
    // Allocate v_7 (operation: Mul)
    v_7 = (float*)malloc(2 * sizeof(float));
    v_7_shape[0] = 2;
    v_7_shape[1] = 1;
    v_7_shape[2] = 1;
    v_7_shape[3] = 1;
    ...
    op_mul(v_4, v_6, v_7, 2);


    // Allocate v_8 (operation: ReduceMax)
    v_8 = (float*)malloc(1 * sizeof(float));
    v_8_shape[0] = 1;
    v_8_shape[1] = 1;
    v_8_shape[2] = 1;
    v_8_shape[3] = 1;
    ...
    v_8[0] = op_reducemax(v_7, 1);


    // Allocate v_9 (operation: Constant)
    v_9 = (float*)malloc(2652 * sizeof(float));
    v_9_shape[0] = 51;
    v_9_shape[1] = 52;
    v_9_shape[2] = 1;
    v_9_shape[3] = 1;
    ...
    // Allocate v_10 (operation: Neg)
    v_10 = (float*)malloc(2652 * sizeof(float));
    v_10_shape[0] = 51;
    v_10_shape[1] = 52;
    v_10_shape[2] = 1;
    v_10_shape[3] = 1;
    ...
    op_neg(v_9, v_10, 2652);


    // Allocate v_11 (operation: ArgMax)
    v_11 = (float*)malloc(51 * sizeof(float));
    v_11_shape[0] = 51;
    v_11_shape[1] = 1;
    v_11_shape[2] = 1;
    v_11_shape[3] = 1;
    ...
    v_11[0] = (float)op_argmax(v_10, 51);


    // Allocate v_12 (operation: Concat3)
    v_12 = (float*)malloc(2756 * sizeof(float));
    v_12_shape[0] = 53;
    v_12_shape[1] = 52;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    // Concat3: using simplified implementation

    op_concat1((const float*[]){v_10}, v_12, (int[]){2756}, 1);


    // Allocate v_13 (operation: Min)
    v_13 = (float*)malloc(2756 * sizeof(float));
    v_13_shape[0] = 53;
    v_13_shape[1] = 52;
    v_13_shape[2] = 1;
    v_13_shape[3] = 1;
    ...
    op_min(v_12, v_2, v_13, 2756);


    // Allocate v_14 (operation: Mul)
    v_14 = (float*)malloc(2756 * sizeof(float));
    v_14_shape[0] = 53;
    v_14_shape[1] = 52;
    v_14_shape[2] = 1;
    v_14_shape[3] = 1;
    ...
    op_mul(v_12, v_8, v_14, 2756);


    // Allocate v_15 (operation: Softmax)
    v_15 = (float*)malloc(2756 * sizeof(float));
    v_15_shape[0] = 53;
    v_15_shape[1] = 52;
    v_15_shape[2] = 1;
    v_15_shape[3] = 1;
    ...
    op_softmax(v_14, v_15, 2756, -1);

    // Copy output v2_0 to output buffer 0
    memcpy(outputs[0], v_11, 51 * sizeof(float));

    // Copy output v1_0 to output buffer 1
    memcpy(outputs[1], v_13, 2756 * sizeof(float));

    // Copy output v4_0 to output buffer 2
    memcpy(outputs[2], v_15, 2756 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v15_0): shape=[1], size=1\n");

    printf("  Input 1 (v0_0): shape=[1x52], size=52\n");

    printf("  Input 2 (v5_0): shape=[1x52], size=52\n");
    ...
    // Output 0: v2_0
    static int output_shape_0[] = {51};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 1;

    // Output 1: v1_0
    static int output_shape_1[] = {53, 52};
    output_shapes[1] = output_shape_1;
    output_ndims[1] = 2;

    // Output 2: v4_0
    static int output_shape_2[] = {53, 52};
    ...
    printf("  Output 1 (v1_0, shape: 53x52):\n");
    printf("  [");
    ...
    printf("  Output 2 (v4_0, shape: 53x52):\n");
    printf("  [");
    for (int j = 0; j < 2756; j++) {
