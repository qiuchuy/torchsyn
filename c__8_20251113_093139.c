...
static int input_shape_0[] = {1, 1, 1};
static int input_shape_1[] = {1, 1};



    // Input 0: v6_0 (shape: 1x1x1)
...
void model_forward(float** inputs, float** outputs,
    ...
    v_2 = (float*)malloc(42 * sizeof(float));
    v_2_shape[0] = 1;
    v_2_shape[1] = 3;
    v_2_shape[2] = 14;
    v_2_shape[3] = 1;
    ...
    v_3 = (float*)malloc(42 * sizeof(float));
    v_3_shape[0] = 1;
    v_3_shape[1] = 3;
    v_3_shape[2] = 14;
    v_3_shape[3] = 1;
    ...
    op_max(v_0, v_2, v_3, 42);


    // Allocate v_4 (operation: ReduceMean)
    ...
    // Allocate v_5 (operation: Sub)
    v_5 = (float*)malloc(42 * sizeof(float));
    v_5_shape[0] = 1;
    v_5_shape[1] = 3;
    v_5_shape[2] = 14;
    v_5_shape[3] = 1;
    ...
    op_sub(v_4, v_3, v_5, 42);


    // Allocate v_6 (operation: Tan)
    v_6 = (float*)malloc(42 * sizeof(float));
    v_6_shape[0] = 1;
    v_6_shape[1] = 3;
    v_6_shape[2] = 14;
    v_6_shape[3] = 1;
    ...
    // Allocate v_7 (operation: Floor)
    v_7 = (float*)malloc(42 * sizeof(float));
    v_7_shape[0] = 1;
    v_7_shape[1] = 3;
    v_7_shape[2] = 14;
    v_7_shape[3] = 1;
    ...
    // Allocate v_8 (operation: LinearInterp)
    v_8 = (float*)malloc(6 * sizeof(float));
    v_8_shape[0] = 1;
    v_8_shape[1] = 3;
    v_8_shape[2] = 2;
    v_8_shape[3] = 1;
    ...
    op_linear_interp(v_6, v_8, 6, 6);


    // Allocate v_9 (operation: ReduceMin)
    v_9 = (float*)malloc(42 * sizeof(float));
    v_9_shape[0] = 3;
    v_9_shape[1] = 14;
    v_9_shape[2] = 1;
    v_9_shape[3] = 1;
    ...
    v_9[0] = op_reducemin(v_6, 42);


    // Allocate v_10 (operation: Div)
    v_10 = (float*)malloc(42 * sizeof(float));
    v_10_shape[0] = 3;
    v_10_shape[1] = 14;
    v_10_shape[2] = 1;
    v_10_shape[3] = 1;
    ...
    op_div(v_9, v_9, v_10, 42);


    // Allocate v_11 (operation: Round)
    v_11 = (float*)malloc(42 * sizeof(float));
    v_11_shape[0] = 3;
    v_11_shape[1] = 14;
    v_11_shape[2] = 1;
    v_11_shape[3] = 1;
    ...
    op_round(v_9, v_11, 42);


    // Allocate v_12 (operation: GELU)
    v_12 = (float*)malloc(42 * sizeof(float));
    v_12_shape[0] = 3;
    v_12_shape[1] = 14;
    v_12_shape[2] = 1;
    v_12_shape[3] = 1;
    ...
    op_gelu(v_11, v_12, 42);

    // Copy output v7_0 to output buffer 0
    memcpy(outputs[0], v_7, 42 * sizeof(float));

    // Copy output v2_0 to output buffer 1
    memcpy(outputs[1], v_8, 6 * sizeof(float));

    // Copy output v12_0 to output buffer 2
    memcpy(outputs[2], v_10, 42 * sizeof(float));

    // Copy output v5_0 to output buffer 3
    memcpy(outputs[3], v_12, 42 * sizeof(float));
...
int main() {
    ...
    printf("  Input 0 (v6_0): shape=[1x1x1], size=1\n");

    printf("  Input 1 (v0_0): shape=[1x1], size=1\n");
    ...
    // Output 0: v7_0
    static int output_shape_0[] = {1, 3, 14};
    output_shapes[0] = output_shape_0;
    output_ndims[0] = 3;

    // Output 1: v2_0
    static int output_shape_1[] = {1, 3, 2};
    output_shapes[1] = output_shape_1;
    output_ndims[1] = 3;

    // Output 2: v12_0
    static int output_shape_2[] = {3, 14};
    output_shapes[2] = output_shape_2;
    output_ndims[2] = 2;

    // Output 3: v5_0
    static int output_shape_3[] = {3, 14};
    ...
    printf("  Output 0 (v7_0, shape: 1x3x14):\n");
    printf("  [");
    for (int j = 0; j < 42; j++) {
    ...
    printf("  Output 1 (v2_0, shape: 1x3x2):\n");
    printf("  [");
    for (int j = 0; j < 6; j++) {
    ...
    printf("  Output 2 (v12_0, shape: 3x14):\n");
    printf("  [");
    for (int j = 0; j < 42; j++) {
    ...
    printf("  Output 3 (v5_0, shape: 3x14):\n");
    printf("  [");
    for (int j = 0; j < 42; j++) {
